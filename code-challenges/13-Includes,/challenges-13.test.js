...
const firstLetters = (arr) => {
  // Solution code here...
  let newArr = arr.map((item)=> item.substring(0,1));
  return newArr;
};
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  let newArr = arr.map((item) => item.substring(1,4)+item.substring(6,9)+item.substring(10,14))
  return newArr
};
...
const onlyOddChars = (str) => {
  // Solution code here...
  // i think I can find a better solution for this
  let newStr = str.substring(1,2)+str.substring(3,4)+str.substring(5,6)+str.substring(7,8)+str.substring(9,10)
  return newStr;
};
...
const findAnything = (arr, target) => {
  // Solution code here...
  let newArr = arr.filter(item => item.includes(target))
  return newArr;
